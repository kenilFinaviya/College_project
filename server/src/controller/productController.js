...
const createProduct = async (req, res) => {
    ...
    try {
        ...
        // console.log(response.product_stock);
...
module.exports = { createProduct, gethomeproduct, getproduct, getsingleproduct, userSelectProduct, updateproduct, deleteproduct };